        ...
        <div className="min-h-screen bg-gray-100">
            ...
            <nav className="bg-blue-600 text-white p-4">
                <div className="container mx-auto flex justify-between items-center">
                    ...
                    <ul
                        className={`md:flex space-x-4 ${isMenuOpen ? "block" : "hidden"} md:block absolute md:static bg-blue-600 w-full md:w-auto top-16 left-0 p-4 md:p-0`}
                    >
                        <li>
                            <a
                                href="#"
            ...
            <div className="container mx-auto p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p className="mt-2 text-gray-600">
                        This is a responsive card with sample content.
                    </p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-md">
                    <h2 className="text-lg font-semibold">Card 2</h2>
                    <p className="mt-2 text-gray-600">
                        Adjust the screen size to see the layout adapt.
                    </p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-md">
